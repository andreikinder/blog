    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative  lg:inline-flex  bg-gray-100 rounded-xl ">
            ...
            <div  x-data="{show : false}" @click.away="show = false">
                <button @click="show = !show" class=" appearance-none bg-transparent py-2 pl-3 pr-9 text-sm font-semibold inline-flex w-full lg:w-32 text-left flex lg:inline-flex" >
